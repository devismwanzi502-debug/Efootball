...
const EMAIL_USER = 'resend';
const EMAIL_PASS = process.env.RESEND_SMTP_PASSWORD;
...
transporter.verify()
  .then(() => console.log('✅ Resend SMTP connection verified'))
  .catch(err => console.error('❌ Resend SMTP connection failed:', err.message));
